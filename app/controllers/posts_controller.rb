class PostsController < ApplicationController
  ...
  def create_app
    ...
    @tip = foursqure.venue_tips(@venue.foursqure_id)
    ...
    if (params[:fb] == 'post')
      ...
      hackid = @post.id.to_s
   	  ...
   	  begin
	      ...
	      :picture => 'http://s3.amazonaws.com/drinkspottingsimages/posts/photos/000/001/' + hackid[1,3] + '/medium/' + @post.photo_file_name + '?' + @post.photo_file_size.to_s,

Drinkspottings::Application.routes.draw do
  ...
  match "/delete_save" => "saves#delete_save"
  
  match "/new_save_app" => "saves#new_save_app"
  match "/delete_save_app" => "saves#delete_save_app"
  ...
  match "app_saves_local" => "iphones#saves_local"
